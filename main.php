    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=start" class="logo">
          <img src="assets/img/logo_2019.png" width="70%" alt="Logo" > 
        </a> 
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="#">UTIC - Proyecto Web</a></strong> <p><a href="" target="_blank"> by Guillermo Garcia</a></p>
      </footer>-->
    </div><!-- ./wrapper -->
